        ...
        <div className=" rounded-lg p-8">
          ...
          <div className="prose max-w-none">
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-[#990c28] mb-4">General privacy policy</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-[#990c28] mb-4">Information that is collected</h2>
              <p className="mb-4 text-gray-700 leading-relaxed">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-[#990c28] mb-4">Cookies</h2>
              <p className="mb-4 text-gray-700 leading-relaxed">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-[#990c28] mb-4">Sensitive information</h2>
              <p className="mb-4 text-gray-700 leading-relaxed">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-[#990c28] mb-4">Disclosure of your personal information</h2>
              <p className="mb-4 text-gray-700 leading-relaxed">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-[#990c28] mb-4">Accessing your personal information</h2>
              <p className="mb-4 text-gray-700 leading-relaxed">
                You can contact us to request a copy of your personal information by emailing our Privacy Officer at <a href="mailto:admin@shootorder.com" className="text-[#990c28] hover:underline">admin@shootorder.com</a>. The Privacy Officer shall attend to your request on a confidential basis within 14 days of the request being received. No fee will be levied for access to this information.
              </p>
            </section>

            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-[#990c28] mb-4">Refusal of access</h2>
              <p className="mb-4 text-gray-700 leading-relaxed">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-[#990c28] mb-4">Data quality</h2>
              <p className="mb-4 text-gray-700 leading-relaxed">
                We will use all reasonable endeavours to ensure the accuracy and quality of the information collected about you. Should personal information that you know has been collected about you change, it is your responsibility to bring the changes to our attention which you may do by email to the Privacy Officer at <a href="mailto:admin@shootorder.com" className="text-[#990c28] hover:underline">admin@shootorder.com</a>
              </p>
            </section>

            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-[#990c28] mb-4">Data security</h2>
              <p className="mb-4 text-gray-700 leading-relaxed">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-[#990c28] mb-4">Information We Collect</h2>
              <p className="mb-4 text-gray-700 leading-relaxed">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-[#990c28] mb-4">How We Use the Information</h2>
              <p className="mb-4 text-gray-700 leading-relaxed">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-[#990c28] mb-4">Facebook Platform Data Usage</h2>
              <p className="mb-4 text-gray-700 leading-relaxed">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-[#990c28] mb-4">Data Sharing</h2>
              <p className="mb-4 text-gray-700 leading-relaxed">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-[#990c28] mb-4">Data Retention and Security</h2>
              <p className="mb-4 text-gray-700 leading-relaxed">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-[#990c28] mb-4">Your Rights</h2>
              <p className="mb-4 text-gray-700 leading-relaxed">
                You can:
              </p>
              <ul className="list-disc pl-6 mb-4 text-gray-700 space-y-2">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-[#990c28] mb-4">Changes to This Policy</h2>
              <p className="mb-4 text-gray-700 leading-relaxed">
            ...
            <div className="border-t-2 border-[#990c28] pt-6 mt-8">
              <p className="text-center text-[#990c28] font-semibold">
                ShootOrder | Digital Marketing Agency Brochure
              </p>
            </div>
          </div>
        </div>
