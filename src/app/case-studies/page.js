...
const CaseStudiesPage = () => {
  ...
  const industryStudies = [
    {
      ...
      description:
        "Revolutionizing patient care through digital transformation",
    ...
    },
    {
      ...
      pdfUrl:
        "/pdfs/case-studies/by-industry/IT & Technology_Orchasp Limited.pdf",
    },
    {
      id: "entertainment",
      title: "Entertainment",
    ...
    },
    {
      ...
      pdfUrl:
        "/pdfs/case-studies/by-industry/Others_Home Healthcare Services Company.pdf",
    },
  ];
  ...
  const processStudies = [
    ...
    },
    {
      ...
      color: "from-purple-600 to-purple-700",
      pdfUrl:
        "/pdfs/case-studies/by-service/Social Media_Luxury Car Dealership.pdf",
    },
  ];
  ...
  const CaseStudyCard = ({ study, isLarge = false, isServiceCard = false }) => (
    <div
      ...
      onClick={() =>
        isServiceCard
          ? handleServiceClick(study.serviceKey)
          : handleCaseStudyClick(study.id)
      }
    >
      ...
      <div className="relative flex flex-col p-6 text-white">
        ...
        <div className="space-y-3">
          ...
          <div className="flex space-x-2">
            ...
            {study.pdfUrl && !isServiceCard && (
              <button
                onClick={(e) => handleDownloadPDF(study.pdfUrl, study.title, e)}
                className="inline-flex items-center space-x-2 bg-[#cd1f38]/80 backdrop-blur-sm px-4 py-2 rounded-lg hover:bg-[#cd1f38] transition-all duration-300 text-sm font-medium"
    ...
    return (
      ...
      >
        ...
        <div className="relative h-full flex flex-col p-6 text-black">
          <div className="mb-4">
            <div className="flex items-center justify-between mb-4">
              <Award className="w-6 h-6 opacity-80 text-[#cd1f38]" />
              <ChevronRight className="w-5 h-5 opacity-60 group-hover:opacity-100 group-hover:translate-x-1 transition-all duration-300 text-[#cd1f38]" />
            </div>

            <h3 className="text-xl font-bold mb-3 group-hover:text-[#cd1f38] transition-colors duration-300">
              {study.title}
            </h3>
          ...
          <div className="space-y-3">
            ...
            <div className="flex space-x-2">
              ...
              {study.pdfUrl && (
                <button
                  onClick={(e) =>
                    handleDownloadPDF(study.pdfUrl, study.title, e)
                  }
                  className="inline-flex items-center space-x-2 bg-[#cd1f38] px-4 py-2 rounded-lg hover:bg-[#b91c47] transition-all duration-300 text-sm font-medium text-white"
                  title={`Download ${study.title} Case Study PDF`}
                >
                  <Download className="w-4 h-4" />
                  <span className="hidden sm:inline">PDF</span>
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-gray-100 to-slate-50">
          ...
          <div>
            <div className="flex items-center mb-10">
              <button
                ...
                className="flex items-center space-x-2 text-[#cd1f38] hover:text-[#b91c47] transition-colors duration-300 mr-6 px-4 py-2 rounded-lg cursor-pointer"
              >
                <ArrowLeft className="w-6 h-6" />
                <span className="text-lg font-medium">Back to Services</span>
              </button>
              <h2 className="font-bold text-4xl text-gray-800">
                {getServiceTitle()} Case Studies
              </h2>
            </div>
      ...
      <div className="relative bg-[#f0f0f1]  text-white py-16">
        ...
        <div className="relative !max-w-4xl mx-auto text-center px-4">
          ...
          <button
            className="cursor-pointer bg-gradient-to-r from-[#cd1f38] to-[#b91c47] text-white px-8 py-4 rounded-lg font-semibold hover:from-[#b91c47] hover:to-[#cd1f38] transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1"
