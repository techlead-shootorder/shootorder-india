...
const caseStudyData = {
  ...
  "ppc-fertility-provider": {
    ...
    businessDescription:
      "Digital Marketing Manager - Point of contact for all Online efforts and Business generation.",
    ...
    approach:
      "By interviewing multiple agencies and evaluating on internal KPI's",

    solution:
      "Have to handle our digital marketing requirements on 360. meet ups every month twice to discuss the strategy, performance and upcoming plans and budgets. Work on website landing pages and social media asset management.",
    ...
    // Team composition
    teamComposition:
      "An dedicated account manager and team under him to take care of our requirement.",

    // Meeting frequency
    meetingSchedule:
      "meet ups every month twice to discuss the strategy, performance and upcoming plans and budgets",
  ...
  "ppc-edtech-company": {
    ...
    // Project Details from PDF
    projectType:
      "Other Digital Marketing, Pay Per Click, Search Engine Optimization",
    budget: "Less than $10,000",
    ...
    // Business Description from PDF
    businessDescription:
      "I´m the CCO of EdTech startup ALPA Kids. ALPA Kids is creating educational mobile applications for children aged 3-8, their parents and teachers to help children learn the essentials like colors, numbers, the alphabet, local flora and fauna etc. through the examples of their own culture and local nature.",
    ...
    challenge:
      "We decided that the best way to rise awareness on Indian market is to hire local digital marketing agency for local campaigns and expansions projects.",

    // Approach/Solution from PDF
    approach:
      "We went through lots of different possibilities to rise awareness about our app but in the end the one that worked the best and still works the best is running Google and Facebook Ads. Shootorder manages those advertising accounts and also creates the creatives for the ads.",

    solution:
      "ShootOrder is helping an EdTech firm leverage digital marketing to raise awareness and expand their reach in India. They manage the client's Facebook and Google Ads accounts and produce creative for the ads.",

    // How they found ShootOrder
    howFound:
      "We used Clutch and Google to create a shortlist of suitable companies and after having several meetings with them we decided to hire Shootorder.",

    // Team composition
    teamComposition:
      "We have worked with several different people in the company but the main contact is our own Account Manager that we can contact any time and who always caters to our needs.",

    // Meeting frequency
    meetingSchedule:
      "We do as many meetings as we need on current phase of expansions. It has changed over the time and at the moment we have a recurring standup meeting in every two weeks.",
    ...
    results: [
      {
        ...
        value: "400,000",
        description:
          "Achieved 400k downloads in India with very limited budget",
      },
      {
      ...
      },
      {
        ...
        value: "Multiple",
        description:
          "Received several good video ads for both Indian and Estonian versions",
      },
      {
        metric: "Awareness Campaign",
        value: "Effective",
        description:
          "Successfully raised awareness in Indian market through targeted campaigns",
      },
    ],
    ...
    // What was impressive from PDF
    impressive:
      "They have the best price-quality ratio. Lots of people helping the client to achieve their target.",

    // Areas for improvement from PDF
    improvements:
      "With our current budget and limitations they have worked wonders for us and we are very satisfied.",
  ...
  "ppc-health-wellness": {
    ...
    // Business Description from PDF
    businessDescription:
      "I'm the brand manager for IPI India, which stands for International Pharmaceuticals, Inc. I'm in charge of marketing, advertising, and branding.",

    // Background context
    backgroundContext:
      "Before working with ShootOrder, we were only doing offline marketing — nothing on the digital front. We scouted a few agencies that could help us gain recognition in the digital world, and selected ShootOrder.",

    challenge:
      "The main challenge was extending our product offerings in the digital space.",

    // Approach/Solution from PDF
    approach:
      "We made a search on Google and interviewed a few agencies, but they either weren't clear on the deliverables or were very expensive. We found ShootOrder after interviewing 3–4 agencies. They were reasonable in terms of cost, and they could offer the services we wanted.",

    solution:
      "ShootOrder has provided SEO and SEM, Google Ads management, and social media management. The ads roll into our Amazon store, so we can track the growth of our order rates. For now, they're managing our Facebook, Instagram, and YouTube profiles. We had a basic website that was done one and a half years back. ShootOrder added relevant keywords to it, changed its structure, and aligned the product offerings in a very convincing manner.",
    ...
    // Team composition
    teamComposition:
      "I'm in regular touch with 5–6 people from their team. We have two brands, each with its own account manager, and they have teams for Google Ads, SEO, and SEM.",

    // Meeting frequency
    meetingSchedule:
      "We have a weekly call with them to discuss analytics, and we visit each other at our offices once a month for a review meeting. We discuss any shortcomings and improvements, and what has transpired in the last period.",
    ...
    results: [
      {
        ...
        value: "10x increase",
        description:
          "Online orders increased from around $100 to $1,000 per month",
      },
      {
    ...
    // Workflow feedback from PDF
    workflow:
      "They share Excel reports with us through Google Drive, covering all the metrics. Their team also prepares documentation for the monthly review meeting, which makes everything easy to understand. There are technical aspects I wouldn't understand if they didn't frame them in laymen's terms.",
    ...
    // Areas for improvement from PDF
    improvements:
      "Their creative execution could be improved, in terms of social media posts. It's just about mediocre, and I think it could be improved.",

    testimonial: {
      quote:
        "They're pretty serious about their job, and they optimize the cash we give them.",
  ...
  "seo-cake-company": {
    ...
    // Business Description from PDF
    businessDescription:
      "CountryOven.com is in the bakery business. One of our verticals is the e-commerce vertical, where we provide gifting for consumers where people can buy gifts for their family and friends online.",

    challenge:
      "Within e-commerce, there are major channels for which we get visitors to the website. SEM [search engine marketing] has provided for a large reason for our traffic. Before ShootOrder, we did not have these kinds of results.",

    // Approach/Solution from PDF
    approach:
      "We work with them on SEO. They have helped us do much better in terms of ranking for specific keywords. They have helped us reach the top position for most of the cake related keywords. Cakes are more than 80% of our revenue. The services they are providing are SEO and SEM.",

    solution:
      "ShootOrder helped achieve top positions for most cake-related keywords through strategic SEO and SEM services. They work closely with the technology team to implement required changes and maintain consistent communication.",
    ...
    results: [
      ...
      },
      {
        ...
        description:
          "Consistent monthly performance improvements over 1.5+ years",
      },
    ],

    // Project Management feedback from PDF
    projectManagement:
      "I feel they're well-organized, stick to the timelines, and their promises. They're very prompt. I email them and they respond quickly.",

    // What was impressive from PDF
    impressive:
      "The head of ShootOrder is a young guy and is very hungry for business. He's always on the go. He makes sure that he talks to our team about the feedback once a month to make sure we are happy with them. They also have a very good knowledge of their core business - SEO. They constantly work with our technology team about the new changes that are required.",

    // Areas for improvement from PDF
    improvements:
      "They could get into other areas of digital marketing. We haven't worked with them in other areas.",
    ...
    // Measurement from PDF
    measurement:
      "We use Google Analytics to measure metrics. There has been good growth in our search engine traffic over a year on year basis. The numbers are much better now.",
  },
  "seo-caravan-rental": {
    ...
    // Approach/Solution from PDF
    approach:
      "Website Development. Social media marketing in the starting and then later on they helped in optimisation of SEO. They help in updating the website and are continuing marketing work for the company.",

    solution:
      "ShootOrder provides website development, SEO, and marketing services for a caravan rental company. The team updates the client's website, handles SMM campaigns, and augments the client's SEO efforts.",
    ...
    // Outcomes from PDF
    outcomes: ["Sales increased", "Profits increased"],
    ...
    results: [
      ...
      },
      {
        ...
        value: "Increased",
        description:
          "Profits increased as a result of improved marketing and SEO",
      },
      {
    ...
    // Project Management feedback from PDF
    projectManagement:
      "Ravi is my project manager. He is very sincere and Hardworking. Yes they deliver everything on time. They respond everything on time.",

    // Communication methods from PDF
    communicationMethods: ["Virtual Meeting", "Email or Messaging App"],
    ...
    // Measurement from PDF
    measurement:
      "With the help of ShootOrder, the client's sales and profit have increased. The goal-oriented team delivers tasks on time and is responsive to queries.",
  },
  "seo-travel-company": {
    ...
    // Project Details from PDF
    projectType:
      "Other Digital Marketing, Social Media Marketing, Web Development",
    budget: "$10,000 to $49,999",
    ...
    // Business Description from PDF
    businessDescription:
      "I'm the founder and CEO of a travel company. We are a very professional leisure travel company and specialized in what we do. We take more of a consultative approach if people are looking for a destination, what to do, what to eat, and where to go. We are specialized in that.",

    challenge:
      "I was looking for a kickstart in social media campaigns to grow my business on platforms like Facebook, Instagram, and Google. Also, our creative collateral had to be up to the standard.",

    // Approach/Solution from PDF
    approach:
      "ShootOrder provided end-to-end social media digital platform services to us in terms of planning promotions on social media, deciding the timing in terms of creativity, and identifying what should go into the creative. They also helped us identify and make efforts to reach our target audience. Their team handles Google Ads and SEO. They also built our website on WordPress. We had an existing website, but they did a completely new look and feel.",

    solution:
      "ShootOrder provides SEO & digital marketing services for a travel company. After identifying a target audience, they run campaigns on the partner's Facebook and Instagram as well as manage their Google Ads.",

    // How they found ShootOrder
    howFound:
      "I was introduced to them by one of my close friends who is very hands-on in terms of their e-commerce business. He had worked with ShootOrder in the past.",

    // Team composition
    teamComposition:
      "I work directly with one person who is my main point of contact. The owner is involved if a very high level of discussion is required.",
    ...
    results: [
      {
        ...
        value: "Increased",
        description:
          "Delivered results in terms of lead generation with growth in business",
      },
      {
      ...
      },
      {
        ...
        value: "Enhanced",
        description:
          "Seen growth in the business and leads with good customer feedback",
      },
      {
        metric: "Target Audience",
        value: "Optimized",
        description:
          "Successfully reaches the correct target audience through strategic campaigns",
      },
    ],

    // Project Management feedback from PDF
    projectManagement:
      "They give us weekly, bi-monthly, and monthly reports. We have discussions based on how our campaign is performing and what the future looks like. We do strategic planning with ShootOrder as well.",

    // What was impressive from PDF
    impressive:
      "ShootOrder used to come with a lot of their initiatives and established with a proper plan. They have hands-on experience in terms of reach, Google Ads, who to target, how much the budget should be, as well as the timing of the promotions. They have expertise in those areas.",
    ...
    advice:
      "I'd definitely recommend them to others so they can benefit from their expertise. For anyone who wants to grow their business digitally, Shoot Order is a reliable company and cost-effective as well.",

    testimonial: {
      quote:
        "For anyone who wants to grow their business digitally, Shoot Order is a reliable company and cost-effective.",
  ...
  "smm-luxury-car-brand": {
    ...
    // Approach/Solution from PDF
    approach:
      "ShootOrder took over all our traditional marketing projects, including Google Ads and social media management.",

    solution:
      "An auto dealer hired ShootOrder to take over their marketing services. The team manages Google Ads and social media. They send status reports on keyword and social media activity.",

    // How they found ShootOrder
    howFound:
      "We needed to find a digital agency, so I searched for well-performing companies in Hyderabad. I found ShootOrder.",

    // Team composition
    teamComposition:
      "I have constant interactions with four people from their team, including Rajat (CEO). Naveen (Digital Marketing Consultant) is the project lead.",
    ...
    results: [
      {
        ...
        value: "Increased",
        description:
          "Successfully increased presence across different digital spaces",
      },
      {
        metric: "Content Delivery",
        value: "Optimized",
        description:
          "Able to deliver content and make quick updates efficiently",
      },
      {
        metric: "Lead Generation",
        value: "Enhanced",
        description:
          "Provided innovative ideas on lead generation and customer engagement",
      },
      {
        metric: "Reporting",
        value: "Prompt",
        description:
          "Timely and accurate reporting on keywords and social media activity",
      },
    ],

    // Project Management feedback from PDF
    projectManagement:
      "The communication is always through me. They send us weekly and fortnightly reports on keywords and social media activity. I submit those to my management.",

    // What was impressive from PDF
    impressive:
      "In the digital space, ROI is very important. ShootOrder always encourages me to streamline the budget for generating leads. Their team looks at what's working and what isn't on different platforms. They've always been willing to come to our office for a meeting, and they always follow up with us.",

    // Areas for improvement from PDF
    improvements:
      "Digital marketing is always evolving, and they have to focus on that part.",

    // Advice for potential customers
    advice:
      "Clients have to be proactive in sensing the market situations and plan accordingly on how to take things forward.",

    testimonial: {
      quote:
        "ShootOrder has performed very well. They're able to deliver content and make quick updates. Their team gives us innovative ideas on lead generation and customer engagement.",
  ...
  "smm-auto-dealership": {
    ...
    // Approach/Solution from PDF
    approach:
      "They manage our digital platforms, handling SEO, PPC, and Google business assets. At this point, they're auditing and improving upon their work on a monthly basis.",

    solution:
      "ShootOrder manages digital platforms for an auto dealership. They handle SEO, PPC, and Google business assets and actively analyze their own performance to determine areas for improvement.",
    ...
    results: [
      {
        ...
        value: "20%",
        description:
          "Their work accounts for about 20% of our current bookings",
      },
      {
        metric: "Traffic & Inquiries",
        value: "Increased",
        description:
          "Digital campaigns attract traffic and inquiries for booking vehicles",
      },
      {
      ...
      },
      {
        ...
        value: "Optimized",
        description:
          "Successfully managing SEO, PPC, and Google business assets with monthly audits",
      },
    ],

    // Project Management feedback from PDF
    projectManagement:
      "We had to do some hand-holding at first, but they were able to work independently later into the project.",
    ...
    // Areas for improvement from PDF
    improvements:
      "No, everything is fine. We review them regularly and give feedback on how they can more efficiently target our audience through digital channels.",

    // Advice for potential customers
    advice:
      "They're quite professional in their approach. There's some hand-holding in the beginning, but that goes away with time.",
    ...
    // Measurement from PDF
    measurement:
      "With their work attracting 20 percent of the client's current customers, ShootOrder has thoroughly satisfied the client. After initial instruction, they have been able to work independently as the project has progressed.",
  },
  "smm-it-services": {
    title:
      "With standout visuals and consistent social media campaigns, ShootOrder amplified visibility for Orchasp’s healthcare tech across Facebook, Instagram, and LinkedIn. ",
    ...
    // Business Description from PDF
    businessDescription:
      "I'm the managing director and CEO of Orchasp Limited, an IT services company. We built an electronic health record platform and wanted to market it on social media.",

    challenge:
      "We built an electronic health record platform and wanted to market it on social media.",
    ...
    solution:
      "An IT services company has hired ShootOrder to promote their EHR platform on social media. The team creates static posts, carousels, and videos to market the platform on Facebook, Instagram, and LinkedIn.",
    ...
    // Team composition
    teamComposition:
      "Initially, I contacted a marketing person. Once we closed the commercial and scope of services, we started interacting with two people. We've also had one escalation point with their boss.",

    // Monthly investment
    monthlyInvestment: "We've spent around 30,000 Indian rupees per month.",

    // Content types created
    contentTypes: ["Static posts", "Carousels", "Educational videos"],
    ...
    // Measurement from PDF
    measurement:
      "The client is impressed with the visuals and videos created by ShootOrder. The team communicates well via WhatsApp and Google Meet. The client has noted that the team has had improved after the first month. However, they expected the team to understand their needs better during the initial meeting.",
  },
};
...
export default async function CaseStudyPage({ params }) {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Hero Section */}
      <div className="relative bg-[#cd1f38] text-white">
      ...
      <div className="!max-w-7xl mx-auto px-4 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <section>
              ...
              <div className="bg-blue-50 p-6 rounded-xl">
                <div className="flex items-center space-x-4">
                  <div className="w-12 h-12 bg-[#cd1f38] rounded-full flex items-center justify-center">
                ...
                {caseStudy.results.map((result, index) => (
                  ...
                  >
                    <div className="flex items-center justify-between mb-4">
                      ...
                      <span className="text-2xl font-bold text-[#cd1f38]">
                        {result.value}
                      </span>
                    </div>
          ...
          <div className="space-y-8">
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                  ...
                  <div className="flex items-center space-x-2">
                    <span className="font-bold text-lg">
                      {caseStudy.ratings.overall}
                    </span>
                    <div className="flex space-x-1">
                      {[...Array(Math.floor(caseStudy.ratings.overall))].map(
                        (_, i) => (
                          <Star
                            key={i}
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-semibold">
                    {caseStudy.ratings.quality}/5
                  </span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-gray-600">Schedule</span>
                  <span className="font-semibold">
                    {caseStudy.ratings.schedule}/5
                  </span>
                </div>
                {/* <div className="flex justify-between items-center">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-semibold">
                    {caseStudy.ratings.wouldRefer}/5
                  </span>
                </div>
              </div>
            </div>
            ...
            {/* CTA */}
            <div className="bg-[#cd1f38] p-6 rounded-xl text-white">
