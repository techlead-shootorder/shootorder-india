          ...
          <div className="relative z-50 h-full overflow-y-auto flex flex-col">
                            ...
                            {expandedCategories[category.title] && (
                              <div className="border-t border-gray-200 bg-white p-4 space-y-3">
                                {(category.links || []).map((_, linkIdx) => (
                                  <div key={linkIdx} className="space-y-2 animate-pulse">
            ...
            <div className="mt-auto p-4 border-t space-y-3">
              <div className="flex items-center gap-3 py-3 px-4 rounded-lg">
                <div className="p-2 rounded-full bg-gray-200 w-10 h-10 animate-pulse"></div>
                              ...
                              <div key={columnIndex} className="space-y-6">
                                ...
                                <div className="space-y-4">
                                  {column.links.map((_, linkIndex) => (
                                    <div key={linkIndex} className="p-4 rounded-xl animate-pulse">
