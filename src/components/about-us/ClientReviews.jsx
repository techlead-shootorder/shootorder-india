...
const ClientReviews = () => {
  const reviews = [
    ...
    },
    {
      ...
      heading:
        "ShootOrder is very understanding, and they’re in sync with our brand. They know exactly what we require.",
      review:
      ...
      <div className="!max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-gray-900 mb-4">
            What Our <span className="text-[#cd1f38]">Clients Say</span>
          </h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Don't just take our word for it. Here's what our valued clients have
            to say about their experience with ShootOrder.
          </p>
        </div>
            ...
            >
              ...
              <div className="flex-shrink-0">
                <div className="relative w-48 h-48 lg:w-56 lg:h-56">
                  <div className="absolute inset-0 bg-gradient-to-br from-[#cd1f38] to-[#c41e3a] rounded-full p-1">
                  ...
                  {/* Decorative elements */}
                  <div className="absolute -top-2 -right-2 w-8 h-8 bg-[#cd1f38] rounded-full opacity-20"></div>
                  <div className="absolute -bottom-3 -left-3 w-6 h-6 bg-[#cd1f38] rounded-full opacity-30"></div>
                </div>
              </div>
              ...
              <div className="flex-1 text-center lg:text-left">
                <div className="bg-white rounded-2xl p-8 shadow-lg relative">
                  ...
                  <div className="absolute -top-4 left-8">
                    <div className="w-8 h-8 bg-[#cd1f38] rounded-full flex items-center justify-center">
                      <svg
                  ...
                  <div className="border-t pt-4">
                    ...
                    <p className="text-[#cd1f38] font-medium">{review.title}</p>
                  </div>

                  {/* Decorative bottom border */}
                  <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-16 h-1 bg-gradient-to-r from-[#cd1f38] to-[#c41e3a] rounded-full"></div>
                </div>
              </div>
            </div>
          ))}
        ...
        <div className="text-center mt-16">
          <div className="bg-gradient-to-r from-[#cd1f38] to-[#c41e3a] rounded-2xl p-8 text-white">
            ...
            <a
              href="/contact-us"
              className="bg-white cursor-pointer text-[#cd1f38] px-8 py-3 rounded-full font-bold hover:bg-gray-100 transition-colors duration-300 shadow-lg hover:shadow-xl"
            >
              Get Started Today
            </a>
          </div>
