...
function ProcessCovered({ services }) {
  ...
  return (
    <div ref={sectionRef} className="h-[100vh] ">
        ...
        {services.features.map((service, index) => (
          ...
          >
            ...
            >
              ...
              <div
                className="absolute inset-0 bg-gradient-to-r from-[#cd1f38]/5 to-transparent opacity-50"
                style={{
            ...
            <div className="w-full px-8 relative pt-[200px]">
              ...
              <h2
                data-heading
                className="text-[15vw] font-bold text-[#cd1f38]/5 leading-none absolute left-1/2 -translate-x-1/2 whitespace-nowrap pointer-events-none"
                style={{
              ...
              >
                <h3 className="text-5xl font-bold text-[#cd1f38] mb-6">
                  {service.heading}
                </h3>
                <p className="text-gray-700 text-xl mb-8 leading-relaxed">
                  {service.content}
                </p>
                <button className="bg-[#cd1f38] text-white px-8 py-4 rounded-lg hover:bg-[#7a0920] transition-colors text-lg">
                  Learn More →
                </button>
              </div>
            </div>
      ...
      {/* <div className="fixed bottom-8 left-0 right-0 h-1 bg-[#cd1f38]/10 z-50">
        <div
          className="h-full bg-[#cd1f38]"
          ref={headingRef}
          style={{
